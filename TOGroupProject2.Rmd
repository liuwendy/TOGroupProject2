...
An ANN is used here to add more prediction accuracy due to its ability to predict much more complex relationships between data easily. Despite the much longer runtime for the ANN as compared to other models in this project, it seems to significantly affect the overall stacked model. 
...
## Conclusion 
Out of all the models created our best model would be our stacked model. Below are the results of the before and after.
...
- # Retained Customers = 8,227
- # Attrited Customer = 193
- Profit from One Retained Customer = $180
- Cost of One Attrited Customer = $750
- Profit from Retained Customers = $1,480,860
- Cost of Attrited Customers = $144,750
- Total Profit = $1,336,110
