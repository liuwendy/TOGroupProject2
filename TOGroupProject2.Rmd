...
just one, k-value. A KNN model first separates data points into several classes to predict the class of a new sample data point based on the number given as the k-value. 
```{r}
library(caret)
